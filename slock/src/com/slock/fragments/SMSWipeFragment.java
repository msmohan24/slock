...
public class SMSWipeFragment extends PreferenceFragment {
    ...
    private DevicePolicyManager devicePolicyManager = SLOCKMainActivity.devicePolicyManager;
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (devicePolicyManager != null && devicePolicyManager.getActiveAdmins() != null) {
            if (devicePolicyManager.isAdminActive(SLOCKMainActivity.adminComponent) && wipeEnabled) {
            ...
            switch (buttonView.getId()) {
                case R.id.wipe_toggle:
                    if (isChecked && !devicePolicyManager
                            .isAdminActive(SLOCKMainActivity.adminComponent)) {
                        addAdmin();
                    }
                    commitToShared();
                    break;
    ...
    private void addAdmin() {
        ...
        intent.putExtra(DevicePolicyManager.EXTRA_DEVICE_ADMIN,
        		SLOCKMainActivity.adminComponent);
        intent.putExtra(
